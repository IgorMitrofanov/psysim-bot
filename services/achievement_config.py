...
ach_config = {
            ...
            AchievementType.SESSION_COUNT: {
                ...
                AchievementTier.SILVER: {'required': 25, 'points': 50},
                AchievementTier.GOLD: {'required': 75, 'points': 100},
                AchievementTier.PLATINUM: {'required': 125, 'points': 200}
            },
            AchievementType.HIGH_RESISTANCE: {
                AchievementTier.BRONZE: {'required': 5, 'points': 30},
                AchievementTier.SILVER: {'required': 25, 'points': 70},
                AchievementTier.GOLD: {'required': 50, 'points': 150}
            },
            ...
            AchievementType.EMOTIONAL_EXPLORER: {
                ...
                AchievementTier.SILVER: {'required': 6, 'points': 50},
            ...
            AchievementType.FEEDBACK_CONTRIBUTOR: {
                AchievementTier.BRONZE: {'required': 7, 'points': 10},
                AchievementTier.SILVER: {'required': 15, 'points': 30},
            ...
            AchievementType.REFERRAL_MASTER: {
                AchievementTier.BRONZE: {'required': 7, 'points': 20},
                AchievementTier.SILVER: {'required': 25, 'points': 100},
                AchievementTier.GOLD: {'required': 50, 'points': 200}
            }
        }
